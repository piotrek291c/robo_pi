 ...
 printf( "111111111111114");
   wyjscie=sonar[0];
    ...
    if(wejscie<=0.05 and wejscie>=-0.05 )
    {
		...
		robot_setVel(0);
		silnik_stop();
		printf( "1111111111111155");
	}
	else
	{
		printf( "1111111111111156");
		...
		wejscie=-2;
		robot_setVel(wejscie);
		printf( "1111111111111157");
     }
      // uśpienie na 2 sekundy 
	// printf( "wejscie: %f wyjscie: %f: cel: %f  \n", wejscie,wyjscie, cel);	 
	printf( "1111111111111159");
     //printf("predkosc robota   %f\n" ,  wejscie); // wyświetlenie komunikatu stop    
  // uśpienie na 2 sekundy 
}
printf( "111111111111116");
}

printf( "111111111111117");
return 0;
}
// -------------------------------------------------------------------------
