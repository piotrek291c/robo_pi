...
float predkosc_silnikow_fast_R()
{
	float predkosc_liniowa=0;
	//float promien=0.035 ; // w metrach [m]
	float promien=3.43 ; // w metrach [cm]
...
//double aggKp=1, aggKi=12, aggKd=0;
//double consKp=0.1, consKi=5, consKd=0;
double aggKp=1, aggKi=16.25, aggKd=0.0007; // bardzo dobre nastawy 
double consKp=0.5, consKi=7.54, consKd=0.0007;       // bardzo dobre nastawy 
//double aggKp=2.93, aggKi=91.6, aggKd=0;       // bardzo dobre nastawy 
//double consKp=1, consKi=16.25, consKd=0.0007; // bardzo dobre nastawy 
//double aggKp=0.5, aggKi=7.54, aggKd=0.0007;       // bardzo dobre nastawy 
//double consKp=0.3314, consKi=4.57, consKd=0.0007; // bardzo dobre nastawy 
...
void go_to_encoder_droga(float pos)
{
   ...
   wyjscie_L=predkosc_silnikow_fast();
   wejscie_L=predkosc_silnikow_PID5(0.591,wyjscie_L);
   silnik_L_Forward(wejscie_L);
	
   wyjscie_R=predkosc_silnikow_fast_R();
   wejscie_R=predkosc_silnikow_PID5(0.5,wyjscie_R);
   silnik_R_Forward(wejscie_R);	
...
//printf("Distance: %dcm\n", getCM());
  ...
  // silnik_stop();
   //predkosc_silnikow_PID(0);
    //predkosc_silnikow_PID_slow(10);
   // predkosc_silnikow_PID3(1);
  //  robot();
