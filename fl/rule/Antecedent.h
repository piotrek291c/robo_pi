...
namespace fl {
    ...
    public:
        ...
        virtual std::string toPrefix(const Expression* node = nullptr) const;
        virtual std::string toInfix(const Expression* node = nullptr) const;
        virtual std::string toPostfix(const Expression* node = nullptr) const;
