...
namespace fl {
    ...
    public:
        ...
        struct FL_API Node {
            ...
            virtual scalar evaluate(const std::map<std::string, scalar>*
                    variables = nullptr) const;

            virtual Node* clone() const;

            virtual std::string toString() const;
            virtual std::string toPrefix(const Node* node = nullptr) const;
            virtual std::string toInfix(const Node* node = nullptr) const;
            virtual std::string toPostfix(const Node* node = nullptr) const;
        private:
    ...
    public:
        ...
        Function(const std::string& name = "",
                const std::string& formula = "", const Engine* engine = nullptr);
        ...
        static Function* create(const std::string& name,
                ...
                const Engine* engine = nullptr); // throw (fl::Exception);
